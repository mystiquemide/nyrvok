  ...
  steps: [
    {
      ...
      calldata: "0x095ea7b3000000000000000000000000cf77a3ba9a5ca399b7c97c748561549736add119000000000000000000000000000000000000000000000000000000000ee6b280",
      value: BigInt(0),
      expectedOutput: "Approved 250 USDC",
      maxSlippageBps: 0,
      label: "Approve Aerodrome Router",
      description: "Authorizes Aerodrome Router to spend 250.00 USDC for multi-hop execution",
      functionName: "approve",
      functionArgs: [BASE_CONTRACTS.AERODROME_ROUTER, "250000000"],
    ...
    },
    {
      ...
      calldata: "0x38ed1739000000000000000000000000000000000000000000000000000000000ee6b280",
      value: BigInt(0),
      expectedOutput: "0.1041 WETH (~$249.85 USD)",
    ...
    },
    {
      ...
      functionName: "approve",
      functionArgs: [BASE_CONTRACTS.MOONWELL_M_WETH, "104100000000000000"],
      abi: ERC20_APPROVE_ABI,
    },
    {
      stepIndex: 3,
      ...
      description: "Supplies 0.1041 WETH to Moonwell money market to earn yield and establish collateral",
      functionName: "mint",
      functionArgs: ["104100000000000000"],
